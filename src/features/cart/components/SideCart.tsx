...
import { BookOpen, Clock, Trash, X } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import { CartItemCategory, SideCartProps } from "../types/cart-types";
  ...
  return (
    <>
      <Drawer direction="left">
        ...
        <DrawerContent className="h-full max-w-md! w-full! bg-white border-none!">
            ...
            {isLoading ? (
              ...
              CART_ITEMS.map((item) => (
                ...
                >
                  <AccordionItem
                    value={item.title}
                    className="p-3 mb-4 border border-[#C7C7CC] rounded-xl"
                  >
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <div className="space-y-2">
                              <h3 className="text-base font-medium text-[#454545] line-clamp-1">
                                {item.title}
                              </h3>
                              {item.instructorName && (
                                <div className="flex items-center gap-2">
          ...
          <DrawerFooter>
            <Button className="bg-pimary! text-white py-3 px-2 h-12 rounded-2xl gap-2 hover:bg-primary/90">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
