...
export default function CourseBundleCard({
  ...
  return (
    <>
      <article className="relative flex h-full min-h-[360px] flex-col overflow-hidden rounded-2xl bg-[#0E3F3A] text-white shadow-[0_18px_42px_rgba(0,128,117,0.18)] transition-transform duration-300 hover:-translate-y-1">
        <button
          type="button"
        ...
        <div className="relative flex flex-1 flex-col p-5 text-right">
          <div className="mb-4 flex flex-wrap items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full bg-[#F7C948] px-3 py-1 text-xs font-bold text-[#1F1F1F]">
          ...
          <div className="mt-auto pt-5">
            <span className="pointer-events-none inline-flex h-10 items-center gap-2 rounded-full bg-white px-4 text-sm font-bold text-primary shadow-[0_10px_24px_rgba(0,0,0,0.16)]">
